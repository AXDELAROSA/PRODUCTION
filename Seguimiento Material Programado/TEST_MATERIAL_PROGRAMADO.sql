...
SELECT * FROM KIT_RUTA (NOLOCK) WHERE ITEM_NO =  'PWLDFCLWLCPX7'
...
SELECT * FROM [MATERIAL_PROGRAMADO_LOG] (NOLOCK) WHERE --K_TIPO_EVENTO_KIT = 30
SERIAL = '32840003'
--AND  ITEM_NO  IN ('PWLDROBWLCPX7', 'PWLDFCLWLCPX7')
ORDER BY K_MATERIAL_PROGRAMADO_LOG DESC

SELECT * FROM [MATERIAL_PROGRAMADO] (NOLOCK) -- WHERE  K_TIPO_EVENTO_KIT = 30 --SERIAL  = '32840003'
...
SELECT * FROM ccjoblin_sql WHERE JOBNO IN ('32805') ORDER BY JOBNO 

SELECT * FROM ccjobhdr_sql WHERE JOBNO IN ('32805') ORDER BY JOBNO
