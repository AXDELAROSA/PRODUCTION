...
SELECT * FROM [MATERIAL_PROGRAMADO_LOG] -- WHERE  K_TIPO_EVENTO_KIT = 410
...
SELECT * FROM ccjoblin_sql WHERE JOBNO IN ('32643') ORDER BY JOBNO 
--SELECT * FROM ccjobhdr_sql WHERE JOBNO IN ('31675') ORDER BY JOBNO

SELECT * FROM PEARL_LOG WHERE JOBNO = '32643'
