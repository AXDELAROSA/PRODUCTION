...
WHERE ITEM_NO  IN ('PTLFSCLWLNPA5')
...
ORDER BY K_MATERIAL_PROGRAMADO_LOG DESC
	...
	FROM KIT_RUTA (NOLOCK)
	INNER JOIN KIT_RUTA_EVENTO (NOLOCK) ON KIT_RUTA_EVENTO.K_KIT_RUTA_EVENTO = KIT_RUTA.K_KIT_RUTA_EVENTO
	WHERE KIT_RUTA.ITEM_NO = 'PTLFSCLWLNPA5'
	AND KIT_RUTA.MODELNO = 'WTL'
	AND KIT_RUTA.VERSIONNO = '0013'
	AND KIT_RUTA.O_KIT_RUTA_EVENTO > (	SELECT  KIT_RUTA.O_KIT_RUTA_EVENTO
										...
										AND KIT_RUTA.MODELNO = 'WTL'
										AND KIT_RUTA.VERSIONNO = '0013'
										AND KIT_RUTA.K_KIT_RUTA_EVENTO = 220 )), 'N/A')
...
SELECT SUM(CONVERT(DECIMAL(13,4),(OriginalQty * stdsqmper))) FROM ccjoblin_sql WHERE JOBNO IN ('36852') AND SER_NO IN ( 4, 6, 7 ) 
SELECT SUM(CONVERT(DECIMAL(13,4),(OriginalQty * stdsqmper))) FROM ccjoblin_sql WHERE JOBNO IN ('36859') AND SER_NO = 9

SELECT * FROM ccjoblin_sql WHERE JOBNO IN ('36859') AND SER_NO = 9

SELECT 360.3660 + 77.6850
