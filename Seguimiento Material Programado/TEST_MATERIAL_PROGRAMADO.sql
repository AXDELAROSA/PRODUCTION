...
SELECT * FROM [MATERIAL_PROGRAMADO_LOG] (NOLOCK) WHERE SERIAL  IN ( '35695001', '36568001') AND K_TIPO_EVENTO_KIT = 1
ORDER BY [K_MATERIAL_PROGRAMADO_LOG] DESC
...
SELECT * FROM ccjoblin_sql WHERE JOBNO IN ('36568') ORDER BY JOBNO 
