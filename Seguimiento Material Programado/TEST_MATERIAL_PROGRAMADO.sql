...
SELECT D_KIT_RUTA_EVENTO, KIT_RUTA.* 
...
AND L_KIT_RUTA_EVENTO = 1

SELECT * FROM [MATERIAL_PROGRAMADO_LOG]  ORDER BY K_MATERIAL_PROGRAMADO_LOG DESC
...
SELECT * FROM ccjoblin_sql WHERE JOBNO IN ('32629', '32630') ORDER BY JOBNO , SER_NO
