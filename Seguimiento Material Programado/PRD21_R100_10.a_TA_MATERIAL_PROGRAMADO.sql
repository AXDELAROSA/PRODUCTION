...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[MATERIAL_PROGRAMADO]') AND type in (N'U'))
	DROP TABLE [dbo].[MATERIAL_PROGRAMADO]
GO
...
CREATE TABLE [dbo].[MATERIAL_PROGRAMADO] (
	[K_MATERIAL_PROGRAMADO]					[INT] IDENTITY (1,1)			NOT NULL,
	-- =================================
	...
	[F_EVENTO]					DATETIME		NOT NULL
)ON [PRIMARY]	
GO

-- //////////////////////////////////////////////////////

ALTER TABLE [dbo].[MATERIAL_PROGRAMADO]
	ADD CONSTRAINT [PK_MATERIAL_PROGRAMADO]
		PRIMARY KEY CLUSTERED ([K_MATERIAL_PROGRAMADO])
GO
