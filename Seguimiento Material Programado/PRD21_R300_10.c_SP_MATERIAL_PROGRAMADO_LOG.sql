...
GO
/*
 EXEC	[dbo].[PG_RPT_MATERIAL_PROGRAMADO_ESCANEADO_X_EVENTO_TURNO] 0,144,  '2022/02/16' , '2022/02/16' , '( TODOS )' , 400 , -1 -- CERTIFICACION
...
AS
	...
	SELECT DISTINCT 
		...
		( CASE WHEN FORMAT(CAST(F_LOG AS TIME(0)), N'hhmmss') > 0 AND FORMAT(CAST(F_LOG AS TIME(0)), N'hhmmss')  < 60002  THEN 3
